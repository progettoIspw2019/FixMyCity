...
L.Control.Coordinates = L.Control.extend({
  ...
  setCoordinates: function (obj) {
    ...
    if (obj.latlng) {
      ...
      document.getElementById("latitudeInputId").value = obj.latlng.lat.toFixed(this.options.precision).toString()
      document.getElementById("longitudeInputId").value = obj.latlng.lng.toFixed(this.options.precision).toString()
